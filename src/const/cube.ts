...
export const GLTF_POSITION_ROTATION_MAP = new Map<PrizeId, PosRot>([
  ["8", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
  ["9", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
  ["10", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
  ["11", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
  ["12", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 0, z: 0 } }],
  ["13", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
  ["14", { position: { x: 0, y: 0, z: 0 }, rotation: { x: 0, y: 180, z: 0 } }],
]);
